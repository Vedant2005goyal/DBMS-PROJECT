...
# Try to install face_recognition and dlib (optional - will continue if fails)
RUN pip install --no-cache-dir face_recognition==1.3.0 dlib==19.24.2 || echo "Warning: face_recognition/dlib installation failed - face recognition features may not work"
